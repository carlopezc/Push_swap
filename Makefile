...
#    Updated: 2025/01/29 12:23:36 by carlopez         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/utils_build_stack.c src/utils_push_swap.c src/build_stack.c src/push.c src/swap.c src/rotate.c src/reverse_rotate.c src/assign_chunks.c src/utils_sort.c src/special_sort.c src/sort.c src/utils.c
OBJ = $(SRC:.c=.o)
