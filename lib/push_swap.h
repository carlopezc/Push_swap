...
/*   Updated: 2025/01/30 10:24:15 by carlopez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list    *choose_next_cheaper(t_list **stack_a, t_list **stack_b, t_list *first, t_list *second, int delimiter);
...
//void	choose_cheaper_back(t_list **stack_a, t_list **stack_b, t_list *first, t_list *second);
...
//void	get_rank(t_list **stack_a, int max, int min);
...
void	print_data(t_list **stack_a, t_list **stack_b); //Solo para comprobaciones
